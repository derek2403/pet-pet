        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <div className="p-6 bg-[#F6F3F9] rounded-xl border border-[#E8E4F0]">
            <div className="flex items-center justify-between mb-3">
              ...
              <Eye className="w-5 h-5 text-[#5A5A5A]" />
            </div>
            <Select defaultValue="private">
              <SelectTrigger className="bg-white border-[#E8E4F0] text-[#6B6B6B]">
                <SelectValue />
              </SelectTrigger>
              <SelectContent>
          ...
          <div className="p-6 bg-[#F6F3F9] rounded-xl border border-[#E8E4F0]">
            <div className="flex items-center justify-between mb-3">
              ...
              <EyeOff className="w-5 h-5 text-[#5A5A5A]" />
            </div>
          ...
          <div className="p-6 bg-[#F6F3F9] rounded-xl border border-[#E8E4F0]">
            <div className="flex items-center justify-between mb-3">
              ...
              <Users className="w-5 h-5 text-[#5A5A5A]" />
            </div>
